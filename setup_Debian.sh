...
if have_sudo_access; then
	...
	if ${SET_MIRRORS}; then
		while read -r sources_list; do
	     ...
	     //cn.archive.deiban.com              //mirrors.tuna.tsinghua.edu.cn
	     //archive.deiban.com                 //mirrors.tuna.tsinghua.edu.cn
	     //security.deiban.com                //mirrors.tuna.tsinghua.edu.cn
